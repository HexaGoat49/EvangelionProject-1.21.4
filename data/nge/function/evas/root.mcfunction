...
# Apply rotation
execute unless entity @p[scores={nge.stateId=4..5}] if entity @p[tag=nge.rotate] store result entity @s Rotation[0] float 1.0 run data get entity @p Rotation[0] 1.0
